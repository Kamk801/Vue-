  ...
  <div class="detail">
    ...
    <section class="con">
      ...
      <div class="conPoin">
        ...
        <span v-show="categoryView.category4Name">{{ categoryView.category4Name }}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        <!-- 左侧放大镜区域 -->
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :skuImageList="skuImage" />
          <!-- 小图列表 -->
          <ImageList :skuImageList="skuImage" />
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{ active: spuSale.isChecked == 1 }"
                  v-for="spuSale in spuSaleAttr.spuSaleAttrValueList" :key="spuSale.id"
                  @click="changeActive(spuSale, spuSaleAttr.spuSaleAttrValueList)">
...
export default {
  ...
  methods: {
    changeActive(spuSale, spuList) {
      for (let item of spuList) {
        item.isChecked = '0';
      }
      spuSale.isChecked = '1';
    },
    ...
    async addShopCart() {
      ...
      try {
        await this.$store.dispatch('detail/addShopCart', { skuid, skunum });
