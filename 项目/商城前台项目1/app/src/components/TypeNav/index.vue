            ...
            <transition name="sort">
                <div class="sort" v-show="NavShow">
                    <div class="all-sort-list2" @click="gosearch">
                        <div class="item" v-for="item in category" :key="item.categoryId">
                            <h3>
                                <a href="javascript:;" :data-categoryname="item.categoryName"
                                    :data-category1id="item.categoryId">{{
                                        item.categoryName
                                    }}</a>
                            </h3>
                            <div class="item-list clearfix">
                                <div class="subitem" v-for="c2 in item.categoryChild" :key="c2.categoryId">
                                    <dl class="fore">
                                        <dt>
