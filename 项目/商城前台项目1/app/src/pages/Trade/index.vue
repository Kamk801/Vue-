  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="item in address" :key="item.id">
        <span :class="{ 'selected': item.isDefault == 1, 'username': true }">{{ item.consignee }}</span>
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="good in detailList" :key="good.skuId">
          <li>
      ...
      <div class="bbs">
        <h5>买家留言:</h5>
        <textarea class="remarks-cont" v-model="msg"></textarea>
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b><i>{{ tradelist.totalNum }}</i>种商品,总商品金额</b>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      await this.$API.subOrder(tradeNo, data).then(res => {
        if (res.code == 200) {
