  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        ...
        <table class="order-item" v-for="item in info.records" :key="item.id">
          <thead>
            <tr>
              <th colspan="5">
                <span class="ordertitle">{{ item.createTime }} 订单编号:{{ item.outTradeNo }} <span class="pull-right delete"><img
          ...
          <tbody>
            <tr>
              <td width="60%">
                <div class="typographic"  v-for="good in item.orderDetailList" :key="good.id" style="height:120px;">
      ...
      <div class="choose-order">
        <pagination :pageNo="page" :pageSize="limit" :total="info.total"
